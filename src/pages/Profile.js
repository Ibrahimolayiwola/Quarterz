  ...
  return (
    <>
      <section className="max-w-4xl md:max-w-6xl  mx-auto flex flex-col items-center justify-center gap-6 ">
        <h2 className="text-slate-200 text-lg font-bold text-center mt-6">
          My Profile
        </h2>
        <div className="w-full md:w-[40%] mt-4">
          <form className="w-full">
            <div className="w-full mb-4">
              <input
                className={`w-full text-gray-800 rounded border-gray-300 transition ease-out duration-200 ${
                  changeDetail && "bg-green-700 text-slate-200"
                }`}
                value={name}
                name="name"
            ...
            <div>
              <input
                className="w-full text-gray-800 rounded border-2 border-gray-300 transition ease-out duration-200"
                value={email}
                name="email"
                disabled
              />
            ...
            <div className=" text-sm flex justify-between mt-6 ">
              ...
              <button
                onClick={signOut}
                className="text-green-800 hover:text-green-600 transition ease-in-out duration-200"
              >
                Sign out
              </button>
            </div>
          ...
          <div>
            <button className="w-full px-4 py-3 bg-green-700 hover:bg-green-800 rounded-md shadow-lg mt-6">
              <Link
                to="/create-list"
                className="text-slate-200 flex items-center justify-center gap-2 text-sm"
              >
      ...
      <section className="mt-9">
        {loading && listings.length === 0 ? (
          ...
          <div className="mx-6xl mx-auto">
            <h2 className=" text-slate-200 font-bold  text-center">
              My Listings
            </h2>
        ...
        {!loading && listings.length === 0 && (
          <p className="text-slate-200">
            You don't have any listings yet. Create one
          </p>
        )}
